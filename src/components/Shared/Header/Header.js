      ...
      <div className="HederSection">
        ...
        <div className="rightHeader">
          <div className="dropdown">
            <button className="btn-header btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
              <div className="DropDownState">
                <div className="icon-class">
                  <FontAwesomeIcon icon={faUserCircle }style={{ height: "40px"}} /> &nbsp;
                </div>
                <div >
